// ══ DATA ══
const products = [
  { id:0, name:"ASUS ProArt Display 4K", cat:"Écrans", icon:"🖥️", price:749900, oldPrice:849900, rating:4.8, ratingCount:142, badge:"new", stock:true,
    ...
    reviews:[
      {name:"Mehdi",stars:5,date:"15 mars 2026",text:"Magnifique écran, les couleurs sont absolument parfaites pour la retouche photo. Livraison très rapide.",helpful:24},
      {name:"Rania",stars:5,date:"02 mars 2026",text:"Qualité d'image exceptionnelle. La calibration d'usine est vraiment au top, aucun réglage nécessaire.",helpful:18},
      {name:"Karim",stars:4,date:"20 fév. 2026",text:"Très bon écran, juste un peu cher mais on en a pour son argent. USB-C très pratique pour le MacBook.",helpful:9},
    ]},
  { id:1, name:"Samsung Odyssey G7", cat:"Écrans", icon:"🖥️", price:489900, rating:4.6, ratingCount:89, badge:null, stock:true,
    specs:"27\" VA Curved 1440p · 240Hz · 1ms · G-Sync compat. · HDR600",
    desc:"Écran gaming courbé 1000R taillé pour la compétition. Le taux de rafraîchissement de 240 Hz et le temps de réponse de 1 ms assurent une fluidité absolue.",
  ...
  { id:2, name:"Keychron Q3 Pro", cat:"Périphériques", icon:"⌨️", price:184900, rating:4.9, ratingCount:204, badge:"new", stock:true,
    specs:"TKL · Hot-swap · Gateron G Pro Brown · Aluminium · Bluetooth 5.1",
    desc:"Clavier mécanique premium 80% en aluminium anodisé avec hot-swap, compatible multi-appareils via Bluetooth ou câble USB-C. Frappe silencieuse et précise.",
    specItems:{Format:"TKL (80%)",Switch:"G Pro Brown",Boîtier:"Aluminium",Connexion:"USB-C / BT",RGB:"Oui"},
    reviews:[
      {name:"Amira",stars:5,date:"18 mars 2026",text:"Le meilleur clavier que j'aie jamais eu. Le son des switches Brown est parfait pour le bureau.",helpful:42},
      {name:"Sofiane",stars:5,date:"05 mars 2026",text:"Build quality exceptionnelle, c'est lourd dans le bon sens. Le hot-swap c'est le luxe.",helpful:28},
    ]},
  { id:3, name:"Logitech MX Master 3S", cat:"Périphériques", icon:"🖱️", price:84900, oldPrice:99900, rating:4.7, ratingCount:512, badge:"promo", stock:true,
    ...
    reviews:[{name:"Nadia",stars:5,date:"12 mars 2026",text:"La molette MagSpeed est tout simplement addictive. Impossible de revenir en arrière.",helpful:67}]},
  { id:4, name:"GeForce RTX 4070 Super", cat:"GPU", icon:"🎮", price:629900, oldPrice:699900, rating:4.8, ratingCount:178, badge:"promo", stock:true,
    specs:"12 GB GDDR6X · DLSS 3 · Ray Tracing · 2560 MHz Boost · PCIe 4.0",
    desc:"La carte graphique parfaite pour le 1440p ultra et le 4K performant. DLSS 3 avec Frame Generation multiplie le nombre d'images par IA.",
    specItems:{VRAM:"12 GB GDDR6X",Boost:"2560 MHz",TDP:"220W",Connecteurs:"3× DP · HDMI",DLSS:"3.5"},
    reviews:[
      {name:"Hocine",stars:5,date:"20 mars 2026",text:"Monstre de puissance ! Les jeux tournent à 4K avec ray tracing activé. Très satisfait.",helpful:55},
      {name:"Farid",stars:4,date:"08 mars 2026",text:"Excellent rapport qualité/prix par rapport à la 4080. Le DLSS 3 est une révolution.",helpful:33},
    ]},
  { id:5, name:"AMD Ryzen 9 7950X", cat:"Processeurs", icon:"🔲", price:549900, rating:4.9, ratingCount:93, badge:null, stock:true,
    ...
    reviews:[{name:"Bilal",stars:5,date:"14 mars 2026",text:"Rendu Blender en temps record. Les 16 cœurs font une différence énorme sur les workloads créatifs.",helpful:39}]},
  { id:6, name:"Samsung 990 Pro 2 TB", cat:"Stockage", icon:"💾", price:149900, rating:4.8, ratingCount:341, badge:"new", stock:true,
    specs:"NVMe PCIe 4.0 · 7450 Mo/s lecture · 6900 Mo/s écriture · M.2 2280",
    desc:"SSD NVMe de nouvelle génération avec des vitesses séquentielles record. Idéal pour les postes créatifs et le gaming.",
    specItems:{Capacité:"2 000 GB",Lecture:"7 450 MB/s",Écriture:"6 900 MB/s",Interface:"PCIe 4.0 x4",Format:"M.2 2280"},
    reviews:[{name:"Wassim",stars:5,date:"11 mars 2026",text:"Les temps de chargement des jeux sont quasi nuls. La vitesse d'écriture est folle pour le montage vidéo.",helpful:28}]},
  { id:7, name:"G.Skill Trident Z5 Neo", cat:"RAM", icon:"🧠", price:134900, rating:4.7, ratingCount:167, badge:null, stock:true,
    ...
    reviews:[{name:"Lydia",stars:5,date:"07 mars 2026",text:"Plug and play avec le Ryzen 7950X et le X670E. Profil Expo activé automatiquement, aucun problème de stabilité.",helpful:19}]},
];
...
function renderProducts() {
  ...
  if (!list.length) { grid.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:60px;color:var(--muted)"><div style="font-size:48px;margin-bottom:12px">🔍</div><div style="font-size:16px;font-weight:500">Aucun produit trouvé</div><div style="font-size:13px;margin-top:6px">Essayez d'autres filtres</div></div>`; return; }
